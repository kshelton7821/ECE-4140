...
// ESOS returns the process for the user to turn on LEDs 0-4 through the SUI
...
// ESOS returns the process for the user to turn off LEDs 0-4 through the SUI
...
// SUI response to user input to toggle LEDs 0-4
