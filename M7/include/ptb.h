...
#include "stm32l4_ocm3/esos_stm32l4_edub_4bit_lcd44780wo.h"
...
//Keypad Macros
//Keypad Init
#define EDUB_KEYPAD_ROW0_SETUP()   gpio_mode_setup(EDUB_KEYPAD_ROW0_PORT, GPIO_MODE_INPUT, GPIO_PUPD_NONE, EDUB_KEYPAD_ROW0_PIN)
#define EDUB_KEYPAD_ROW1_SETUP()   gpio_mode_setup(EDUB_KEYPAD_ROW1_PORT, GPIO_MODE_INPUT, GPIO_PUPD_NONE, EDUB_KEYPAD_ROW1_PIN)
#define EDUB_KEYPAD_ROW2_SETUP()   gpio_mode_setup(EDUB_KEYPAD_ROW2_PORT, GPIO_MODE_INPUT, GPIO_PUPD_NONE, EDUB_KEYPAD_ROW2_PIN)
#define EDUB_KEYPAD_ROW3_SETUP()   gpio_mode_setup(EDUB_KEYPAD_ROW3_PORT, GPIO_MODE_INPUT, GPIO_PUPD_NONE, EDUB_KEYPAD_ROW3_PIN)
#define EDUB_KEYPAD_COL0_SETUP()   gpio_mode_setup(EDUB_KEYPAD_COL0_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, EDUB_KEYPAD_COL0_PIN)
#define EDUB_KEYPAD_COL1_SETUP()   gpio_mode_setup(EDUB_KEYPAD_COL1_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, EDUB_KEYPAD_COL1_PIN)
#define EDUB_KEYPAD_COL2_SETUP()   gpio_mode_setup(EDUB_KEYPAD_COL2_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, EDUB_KEYPAD_COL2_PIN)
#define EDUB_KEYPAD_COL3_SETUP()   gpio_mode_setup(EDUB_KEYPAD_COL3_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, EDUB_KEYPAD_COL3_PIN)
//Keypad Marcros
...
//Maybe these will help determine keypad or switch?
#define EDUB_KEYPAD_COL0_GETVAL()  gpio_get(EDUB_KEYPAD_COL0_PORT, EDUB_KEYPAD_COL0_PIN)
#define EDUB_KEYPAD_COL1_GETVAL()  gpio_get(EDUB_KEYPAD_COL1_PORT, EDUB_KEYPAD_COL1_PIN)
#define EDUB_KEYPAD_COL2_GETVAL()  gpio_get(EDUB_KEYPAD_COL2_PORT, EDUB_KEYPAD_COL2_PIN)
#define EDUB_KEYPAD_COL3_GETVAL()  gpio_get(EDUB_KEYPAD_COL3_PORT, EDUB_KEYPAD_COL3_PIN)
