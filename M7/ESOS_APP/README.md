...
// uint32_t volatile u32t_led0_period_half = 500: the half periods will set all the leds to be 500 ms to ensure that the period is exactly half for all of the rperiods
